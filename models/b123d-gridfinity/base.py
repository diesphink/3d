    ...
    def __init__(
        ...
        with BuildPart() as baseblock:
            ...
            if magnets or screwholes:
                ...
                distance = bot_plane.bounding_box().size.X - 2 * gridfinity_standard.bottom.hole_from_side
        ...
        with BuildSketch() as profile:
            with BuildLine():
                Polyline(
                    ...
                    (
                        gridfinity_standard.stacking_lip.height_1,
                        gridfinity_standard.stacking_lip.height_1 + gridfinity_standard.stacking_lip.height_2,
                    ),
                    (
                        gridfinity_standard.stacking_lip.height_1 + gridfinity_standard.stacking_lip.height_3,
                        gridfinity_standard.stacking_lip.height_1
